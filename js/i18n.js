...
window.I18n = (function () {
  ...
  var translations = {
    ...
    ja: {
      ...
      'beta.chat.label.image': 'スクリーンショット',
      'beta.chat.label.image.opt': '（任意・5MBまで）',
      'beta.chat.image.btn': '画像を選択',
      ...
      'js.tester.image_invalid_type': '画像ファイル（JPG, PNG, GIF, WebP）を選択してください。',
      'js.tester.image_too_large': '画像サイズが大きすぎます（5MB以下にしてください）。',
      'js.tester.image_alt': '添付画像',
      'js.tester.chat_confirm': 'この内容で投稿します。よろしいですか？',
      'js.tester.chat_confirm_name': '名前',
      'js.tester.chat_confirm_message': 'メッセージ',
      'js.tester.chat_confirm_image': '📎 画像添付あり',
    ...
    en: {
      ...
      'beta.chat.label.image': 'Screenshot',
      'beta.chat.label.image.opt': '(Optional — up to 5MB)',
      'beta.chat.image.btn': 'Choose Image',
      ...
      'js.tester.image_invalid_type': 'Please select an image file (JPG, PNG, GIF, or WebP).',
      'js.tester.image_too_large': 'Image is too large (maximum 5MB).',
      'js.tester.image_alt': 'Attached image',
      'js.tester.chat_confirm': 'Post this message?',
      'js.tester.chat_confirm_name': 'Name',
      'js.tester.chat_confirm_message': 'Message',
      'js.tester.chat_confirm_image': '📎 Image attached',
