...
window.I18n = (function () {
  ...
  var translations = {
    ...
    ja: {
      ...
      'beta.android.banner': 'このページは <strong>Androidユーザー専用</strong> です。<br>現在、iOS（iPhone / iPad）版には対応しておりません。',
    ...
    en: {
      ...
      'beta.android.banner': 'This page is <strong>for Android users only</strong>.<br>iOS (iPhone / iPad) is not currently supported.',
