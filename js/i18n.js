...
window.I18n = (function () {
  ...
  var translations = {
    ...
    ja: {
      ...
      'beta.14banchi.cta.lead': 'アカウントの確認ができたら、下のボタンからテストに参加しましょう。',
      'beta.14banchi.cta.btn': 'テストに参加してインストールする',
      'beta.14banchi.cta.note': 'ボタンを押すと Google Play のテスト参加ページが開きます',
      'beta.14banchi.steps.heading': 'インストール手順（3ステップ）',
      'beta.14banchi.steps.intro': '上のボタンを押した後の流れを、実際の画面で説明します。',
      'beta.14banchi.step1.title': '「テスターになる」を押す',
      'beta.14banchi.step1.p1': 'ボタンを押すと、下のような画面が開きます。<br>画面の一番下にある<strong>「テスターになる」</strong>ボタンを押してください。これがテストへの参加表明になります。',
      'beta.14banchi.step1.note1': '※ 最初は英語で <strong>"Become a tester"</strong> と表示される場合があります。下の画像は日本語に翻訳した状態です。ページを日本語に翻訳してから操作すると分かりやすいのでおすすめです。',
      'beta.14banchi.step1.note2': '※ この画面が表示されない場合は、登録したGoogleアカウントでログインしているか確認してください。',
      'beta.14banchi.step2.title': '「Google Play でダウンロード」を押す',
      'beta.14banchi.step2.p1': '「あなたはテスターです。」（英語では <strong>"You\'re a tester"</strong>）と表示されたら参加完了です！<br>画面の中にある青い文字の<strong>「Google Play でダウンロードしてください」</strong>（英語では <strong>"download it on Google Play"</strong>）というリンクを押してください。',
      'beta.14banchi.step2.note1': '※ リンクが有効になるまで数分かかる場合があります。表示されない場合は少し待ってからページを更新してください。',
      'beta.14banchi.step3.title': '「インストール」を押す',
      'beta.14banchi.step3.p1': 'Google Playのアプリページが開きます。<br>青色の<strong>「インストール」</strong>ボタンを押せば、ダウンロードが始まります。これで完了です！',
      'beta.14banchi.launch.main': '📲 <strong>インストール後、必ず一度アプリを起動してください。</strong>',
      'beta.14banchi.launch.desc': 'ダウンロードしただけではテストへの参加が完了しません。アプリを一度起動することで、正式にテスト参加者として登録されます。',
      // バグ報告
    ...
    en: {
      ...
      'beta.14banchi.cta.lead': 'Once you\'ve confirmed your account, tap the button below to join the test.',
      'beta.14banchi.cta.btn': 'Join Test & Install',
      'beta.14banchi.cta.note': 'This button opens the Google Play test page',
      'beta.14banchi.steps.heading': 'Installation Steps (3 Steps)',
      'beta.14banchi.steps.intro': 'Here\'s what happens after tapping the button above.',
      'beta.14banchi.step1.title': 'Tap "Become a tester"',
      'beta.14banchi.step1.p1': 'After tapping the button, a screen like the one below will open.<br>Tap the <strong>"Become a tester"</strong> button at the bottom of the screen. This confirms your participation.',
      'beta.14banchi.step1.note1': '* The page may initially appear in English showing <strong>"Become a tester"</strong>. The image below shows the Japanese-translated version.',
      'beta.14banchi.step1.note2': '* If this screen doesn\'t appear, make sure you\'re signed in with the registered Google Account.',
      'beta.14banchi.step2.title': 'Tap "download it on Google Play"',
      'beta.14banchi.step2.p1': 'Once you see <strong>"You\'re a tester"</strong>, you\'re in!<br>Tap the blue link <strong>"download it on Google Play"</strong> on the screen.',
      'beta.14banchi.step2.note1': '* The link may take a few minutes to become active. If it doesn\'t appear, wait and refresh the page.',
      'beta.14banchi.step3.title': 'Tap "Install"',
      'beta.14banchi.step3.p1': 'The Google Play app page will open.<br>Tap the blue <strong>"Install"</strong> button to start the download. You\'re all set!',
      'beta.14banchi.launch.main': '📲 <strong>Please launch the app at least once after installation.</strong>',
      'beta.14banchi.launch.desc': 'Just downloading is not enough to complete test registration. Launching the app once officially registers you as a test participant.',
      // Bug Report
