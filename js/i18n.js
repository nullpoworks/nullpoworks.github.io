...
window.I18n = (function () {
  ...
  var translations = {
    ...
    ja: {
      ...
      // PWAインストールガイド
      'pwa.title': 'PWAインストール方法',
      'pwa.lead': '「Web / PWA」対応のゲームは、ブラウザからホーム画面に追加するだけで<br>アプリのように遊べます。以下の手順でインストールしてください。',
      'pwa.ios.step1': '<strong>Safari</strong> でゲームのページを開く',
      'pwa.ios.step2': '画面下の <strong>共有ボタン</strong>（□に↑）をタップ',
      'pwa.ios.step3': '「<strong>ホーム画面に追加</strong>」をタップ',
      'pwa.ios.step4': '右上の「<strong>追加</strong>」をタップして完了！',
      'pwa.ios.note': '※ Safari以外のブラウザでは「ホーム画面に追加」が表示されません。',
      'pwa.android.step1': '<strong>Chrome</strong> でゲームのページを開く',
      'pwa.android.step2': '右上の <strong>メニュー</strong>（︙）をタップ',
      'pwa.android.step3': '「<strong>ホーム画面に追加</strong>」または「<strong>アプリをインストール</strong>」をタップ',
      'pwa.android.step4': '確認画面で「<strong>インストール</strong>」をタップして完了！',
      'pwa.android.note': '※ 「アプリをインストール」と表示される場合もあります。',
      'pwa.pc.title': 'PC（Chrome / Edge）',
      'pwa.pc.step1': '<strong>Chrome</strong> または <strong>Edge</strong> でゲームのページを開く',
      'pwa.pc.step2': 'アドレスバー右端の <strong>インストールアイコン</strong>（⊕）をクリック',
      'pwa.pc.step3': '「<strong>インストール</strong>」をクリックして完了！',
      'pwa.pc.note': '※ アイコンが表示されない場合はメニュー（︙）→「アプリをインストール」から追加できます。',
      ...
      'contact.faq.q2': '「ホーム画面に追加」が見つからない',
      'contact.faq.a2': '<p>お使いのブラウザによって手順が異なります。</p><ul><li><strong>iPhone / iPad</strong>：必ず <strong>Safari</strong> を使用してください。Chrome等では「ホーム画面に追加」は表示されません。画面下の共有ボタン（□に↑）からメニューを開いてください。</li><li><strong>Android</strong>：<strong>Chrome</strong> の右上メニュー（︙）を開き、「ホーム画面に追加」または「アプリをインストール」を選択してください。</li><li><strong>PC</strong>：Chrome / Edge のアドレスバー右端にあるインストールアイコン（⊕）をクリックしてください。表示されない場合はメニュー（︙）から「アプリをインストール」を選択してください。</li></ul><p>詳しくは<a href="index.html#pwa-guide">PWAインストール方法</a>をご覧ください。</p>',
      'contact.faq.q3': 'PWAアプリが画面からはみ出る・表示がおかしい',
      'contact.faq.a3': '<p>一度アプリを削除して再インストールすると改善する場合があります。また、端末のOSやブラウザが古いバージョンの場合、正しく表示できないことがあります。</p><ul><li>端末のOSを最新バージョンにアップデートしてください</li><li>ブラウザ（Safari / Chrome）も最新バージョンに更新してください</li></ul><p>それでも解決しない場合は、お問い合わせフォームから端末名とブラウザ名をお知らせください。</p>',
      'contact.faq.q4': 'PWAアプリはオフラインでも遊べますか？',
      'contact.faq.a4': '<p>はい、一度インストールすればオフラインでもプレイ可能です。ただし、初回アクセス時やアップデート時にはインターネット接続が必要です。</p>',
    ...
    en: {
      ...
      // PWA Install Guide
      'pwa.title': 'How to Install PWA',
      'pwa.lead': 'Games marked "Web / PWA" can be installed to your home screen<br>and played just like a native app. Follow the steps below.',
      'pwa.ios.step1': 'Open the game page in <strong>Safari</strong>',
      'pwa.ios.step2': 'Tap the <strong>Share button</strong> (square with arrow) at the bottom',
      'pwa.ios.step3': 'Tap "<strong>Add to Home Screen</strong>"',
      'pwa.ios.step4': 'Tap "<strong>Add</strong>" in the top right — done!',
      'pwa.ios.note': '* "Add to Home Screen" is only available in Safari.',
      'pwa.android.step1': 'Open the game page in <strong>Chrome</strong>',
      'pwa.android.step2': 'Tap the <strong>menu</strong> (⋮) in the top right',
      'pwa.android.step3': 'Tap "<strong>Add to Home screen</strong>" or "<strong>Install app</strong>"',
      'pwa.android.step4': 'Tap "<strong>Install</strong>" on the confirmation dialog — done!',
      'pwa.android.note': '* It may show "Install app" instead of "Add to Home screen."',
      'pwa.pc.title': 'PC (Chrome / Edge)',
      'pwa.pc.step1': 'Open the game page in <strong>Chrome</strong> or <strong>Edge</strong>',
      'pwa.pc.step2': 'Click the <strong>install icon</strong> (⊕) at the right end of the address bar',
      'pwa.pc.step3': 'Click "<strong>Install</strong>" — done!',
      'pwa.pc.note': '* If the icon doesn\'t appear, go to menu (⋮) → "Install app."',
      ...
      'contact.faq.q2': 'Can\'t find "Add to Home Screen"',
      'contact.faq.a2': '<p>The steps differ depending on your browser:</p><ul><li><strong>iPhone / iPad</strong>: You must use <strong>Safari</strong>. "Add to Home Screen" is not available in Chrome or other browsers. Tap the Share button (square with arrow) at the bottom of the screen.</li><li><strong>Android</strong>: Open <strong>Chrome</strong>, tap the menu (⋮) in the top right, and select "Add to Home screen" or "Install app."</li><li><strong>PC</strong>: Click the install icon (⊕) at the right end of the address bar in Chrome / Edge. If it doesn\'t appear, go to menu (⋮) → "Install app."</li></ul><p>For detailed steps, see <a href="index.html#pwa-guide">How to Install PWA</a>.</p>',
      'contact.faq.q3': 'PWA app display is broken or overflows the screen',
      'contact.faq.a3': '<p>Deleting and reinstalling the app may fix the issue. Display problems can also occur if your device OS or browser is outdated.</p><ul><li>Update your device OS to the latest version</li><li>Update your browser (Safari / Chrome) to the latest version</li></ul><p>If the problem persists, please contact us with your device model and browser name.</p>',
      'contact.faq.q4': 'Can I play PWA apps offline?',
      'contact.faq.a4': '<p>Yes, once installed, you can play offline. However, an internet connection is required for the first access and for updates.</p>',
