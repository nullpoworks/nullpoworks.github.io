...
window.I18n = (function () {
  ...
  var translations = {
    ...
    ja: {
      ...
      'beta.android.banner': 'このページは <strong>Androidユーザー専用</strong> です。<br>iOSをご利用の方は<a href="index.html" class="beta-android-banner-link">トップページ</a>からアプリ情報をご覧ください。',
      ...
      'beta.hero.note': 'テストユーザー様はどのアプリのテストプレイにもご参加いただけます。',
    ...
    en: {
      ...
      'beta.android.banner': 'This page is <strong>for Android users only</strong>.<br>If you are an iOS user, please visit the <a href="index.html" class="beta-android-banner-link">top page</a> for app information.',
      ...
      'beta.hero.note': 'As a registered tester, you are welcome to participate in test play for any of our apps.',
